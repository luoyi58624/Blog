...
<div class="goods_list" id="account_List">
    ...
    <ul class="list_goods_ul">
        <li>01</li>
        <li>Myxq</li>
        <li><a href="#"><img class="img_icon" src="${pageContext.request.contextPath}/static_resource/images/edit_icon.png" alt=""></a></li>
        <li><a href="#"><img class="img_icon" src="${pageContext.request.contextPath}/static_resource/images/delete_icon.png" alt=""></a></li>
    </ul>
