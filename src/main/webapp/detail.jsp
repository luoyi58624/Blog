...
<script>
	...
	$.post("${pageContext.request.contextPath}/jsonCategoryArticle/jsonCurrentArticle/"+article_id,function (data) {
		$(".main-title:eq(0)").html(data.articleTitle);
		$(".main-time:eq(0)").html(new Date(data.articleTime).toLocaleDateString());
